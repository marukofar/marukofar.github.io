...
แฮกเกอร์แค่พิมพ์ คำสั่ง SQL ' or 1=1 เป็นค่าจริง (True) เสมอ ซึ่งเป็นการเปรียบเทียบเงื่อนในการดึงข้อมูลจากฐานข้อมูล ฐานข้อมูลเมื่อรับค่ามาว่า or 1=1 มีไหม ซึ่งแน่นอนว่ามีเพราะค่า or 1=1 มีค่าเป็นจริง (True) ทำให้ฐานข้อมูลส่งคืนค่า user ทั้งหมดกลับไป ทำให้แฮกเกอร์ได้ข้อมูลทั้งหมด หรือทำเข้าสู่ระบบของเว็บนั้นได้
